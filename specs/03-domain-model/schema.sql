-- RAEED — MVP database schema (PostgreSQL 15+)
...
-- ============================================================
-- Grants — enforce "logs cannot be edited, even by executives" (AUD-04) at the DB level
-- ============================================================
-- Run once per environment, after the app's runtime role exists:
--   revoke update, delete on audit_log_entry from raeed_app;
--   grant insert, select on audit_log_entry to raeed_app;
--   -- only a separate, rarely-used role may run the retention purge job (10-security-and-privacy.md)
